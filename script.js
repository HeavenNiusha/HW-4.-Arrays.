const  students=["Emilia", "George", "Helena", "John", "Alana", "Victoria"];
const themes=["Algorithm and data structure","Automatic theory", "Differential equotations", "Pifagor's theory", "Theory of math logic"];
